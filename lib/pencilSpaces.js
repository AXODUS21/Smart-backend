// Pencil Spaces API base URL - from https://api.pencilspaces.com/reference
const API_BASE_URL =
  process.env.PENCIL_SPACES_API_BASE_URL ||
  "https://api.pencilspaces.com";
...
export async function createPencilSpace({
  ...
  // Minimal Space creation – Pencil will associate it with the API key owner.
  // We intentionally do NOT include hosts/participants here so this works even
  // when user-management endpoints aren't available on the account.
  const body = {
